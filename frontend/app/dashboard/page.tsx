  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">⚡ Vigil-AI</h1>
          <p className="text-gray-400 text-sm">AI that watches over your neighborhood 24/7</p>
        </div>
        ...
        <div className="bg-gray-900 border border-gray-700 p-6 rounded-2xl mb-6">
          ...
          {aiLoading ? (
            ...
            <p className="text-gray-100 leading-relaxed">{aiSummary || "Enter a zip code to get your AI safety summary"}</p>
          )}
        </div>
